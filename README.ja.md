...
- [ホスト版 DocC](https://swiftpackageindex.com/KoichiroKAMADA/Yashima/1.0.0/documentation/yashima): Swift Package Index がビルド・ホストするバージョン別 API ドキュメント。
- [Swift Package Index](https://swiftpackageindex.com/KoichiroKAMADA/Yashima): パッケージの検索ページと実測ビルド互換性。
...
- [無限時計](https://apps.apple.com/jp/app/%E7%84%A1%E9%99%90%E6%99%82%E8%A8%88/id1064833509): 大きく見やすい表示と豊富なカスタマイズを備えた、作者報告で 200 万ダウンロード超の時計アプリです。Yashima は背景画像サムネイル、色/ぼかしフィルタープレビュー、背景動画サムネイル、動画時間メタデータの再利用に使われています。
