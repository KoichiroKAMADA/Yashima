...
struct ArtifactRecipe: Identifiable, Hashable, Sendable {
    ...
    static let samples: [ArtifactRecipe] = [
        ArtifactRecipe(
            ...
            shortTitle: "Map",
            subtitle: "MapKit snapshot from a full 9,653-point GPX route",
            systemImageName: "map",
            spec: .map(
                MapSnapshotSpec(
                    ...
                    routePointCount: 9_653,
                    sourcePointCount: 9_653,
                    distanceKilometers: 108.1,
                    routeDescription: "Full GPX coordinates, metadata stripped",
